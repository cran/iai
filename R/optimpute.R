...
#'
#' Julia Equivalent:
#' \href{https://docs.interpretable.ai/v3.1.1/OptImpute/reference/#IAI.impute}{\code{IAI.impute}}
#'
...
#'
#' Julia Equivalent:
#' \href{https://docs.interpretable.ai/v3.1.1/OptImpute/reference/#IAI.impute_cv}{\code{IAI.impute_cv}}
#'
#' This function was deprecated in iai 1.7.0. This is for consistency with the
#' IAI v3.0.0 Julia release.
#'
...
#'
#' Julia Equivalent:
#' \href{https://docs.interpretable.ai/v3.1.1/OptImpute/reference/#IAI.ImputationLearner}{\code{IAI.ImputationLearner}}
#'
...
#'
#' Julia Equivalent:
#' \href{https://docs.interpretable.ai/v3.1.1/OptImpute/reference/#IAI.OptKNNImputationLearner}{\code{IAI.OptKNNImputationLearner}}
#'
#' @param ... Use keyword arguments to set parameters on the resulting learner.
#'            Refer to the Julia documentation for available parameters.
#'
...
#'
#' Julia Equivalent:
#' \href{https://docs.interpretable.ai/v3.1.1/OptImpute/reference/#IAI.OptSVMImputationLearner}{\code{IAI.OptSVMImputationLearner}}
#'
#' @param ... Use keyword arguments to set parameters on the resulting learner.
#'            Refer to the Julia documentation for available parameters.
#'
...
#'
#' Julia Equivalent:
#' \href{https://docs.interpretable.ai/v3.1.1/OptImpute/reference/#IAI.OptTreeImputationLearner}{\code{IAI.OptTreeImputationLearner}}
#'
#' @param ... Use keyword arguments to set parameters on the resulting learner.
#'            Refer to the Julia documentation for available parameters.
#'
...
#'
#' Julia Equivalent:
#' \href{https://docs.interpretable.ai/v3.1.1/OptImpute/reference/#IAI.SingleKNNImputationLearner}{\code{IAI.SingleKNNImputationLearner}}
#'
#' @param ... Use keyword arguments to set parameters on the resulting learner.
#'            Refer to the Julia documentation for available parameters.
#'
...
#'
#' Julia Equivalent:
#' \href{https://docs.interpretable.ai/v3.1.1/OptImpute/reference/#IAI.MeanImputationLearner}{\code{IAI.MeanImputationLearner}}
#'
#' @param ... Use keyword arguments to set parameters on the resulting learner.
#'            Refer to the Julia documentation for available parameters.
#'
...
#'
#' Julia Equivalent:
#' \href{https://docs.interpretable.ai/v3.1.1/OptImpute/reference/#IAI.ZeroImputationLearner}{\code{IAI.ZeroImputationLearner}}
#'
#' @param ... Use keyword arguments to set parameters on the resulting learner.
#'            Refer to the Julia documentation for available parameters.
#'
...
#'
#' Julia Equivalent:
#' \href{https://docs.interpretable.ai/v3.1.1/OptImpute/reference/#IAI.fit_and_expand!}{\code{IAI.fit_and_expand!}}
#'
...
#'
#' Julia Equivalent:
#' \href{https://docs.interpretable.ai/v3.1.1/OptImpute/reference/#IAI.transform_and_expand}{\code{IAI.transform_and_expand}}
#'
#' @param lnr The learner to use for imputation.
#' @param X The dataframe in which to impute missing values.
#' @param ... Refer to the Julia documentation for available parameters.
